...
export class RethinkdbCqrsEngine<E, C, Q, R,
  ET, CT, QT, RT,
  qh extends query_handler<any, any, any, any>> implements cqrs_engine<E, C, Q, R,
  ET, CT, QT, RT,
  qh> {
