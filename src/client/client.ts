import { Body, Controller, Post } from 'nest-client';
...
import { CqrsService } from '../server/service';

@Controller('cqrs')
export class CqrsClient<Command extends ICommand<Command['command'], Command['result'], Event, Command['type']>,
